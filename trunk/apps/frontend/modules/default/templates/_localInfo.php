...
<div class="left1">
    <div class="testimonials">
        <h2 class="smallBlack"><span class="black2"><?php echo $profile->getValue("nombre"); ?></span></h2>
        <?php 
        ...
        <div class="blueBg">
            ...
            <div class="blueBgPic">
                <a class="grouped_images" rel="group<?php echo $local->getId();?>" href="<?php echo $avatar->getUrl(array(mdWebOptions::WIDTH => 640, mdWebOptions::HEIGHT => 480,  mdWebOptions::CODE => mdWebCodes::CROPRESIZE)); ?>" title="" >
                    <img src="<?php echo $avatar->getUrl(array(mdWebOptions::WIDTH => 58, mdWebOptions::HEIGHT => 58,  mdWebOptions::CODE => mdWebCodes::CROPRESIZE)); ?>" alt="" />
                </a>
            </div>
            <div class="hidden"> 
    ...
    <div class="services">
        ...
        <ul>
            ...
            <li><strong><?php echo __("locales_Descripcion:");?></strong><span><?php echo $profile->getValue("descripcionLocal"); ?></span></li> 
        </ul><br class="spacer" />
    </div>
</div>
<br class="spacer" />
