...
class mdAttributeWidgetTextInput extends mdAttribute implements iMdAttribute{

	private $value = null;
	
	public function getWidget(){
		if($this->value != null){
			return new sfWidgetFormInputConfigurable(array('value'=>$this->value, 'label'=>$this->getLabel()));
		}
		return new sfWidgetFormInputConfigurable(array('label'=>$this->getLabel()));
	}
	...
	public function getValidator(){
		...
		return new sfValidatorString(array('max_length' => 255,'required'=>false));
