...
?> 
<input type="button" onclick="mdSortingManagement.getInstance().retriveObjects(this, '<?php echo url_for("mdSortable/bringObjects"); ?>', '<?php echo $className?>');" value="traer objectos"/>
