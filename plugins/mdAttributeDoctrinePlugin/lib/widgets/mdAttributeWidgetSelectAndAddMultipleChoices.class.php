...
class mdAttributeWidgetSelectAndAddMultipleChoices extends mdAttribute implements iMdAttribute{
	...
	public function getWidget(){
		...
		if($this->attValueId != null){
			...
			$widget = new mdWidgetSelectAndAddMultipleChoices(array('choices'=>$values,'default' => $this->attValueId ,'expanded' => false,'multiple' => true)); 
			$widget->setDefault($this->attValueId);
			return $widget;
			
		}*/
		return new mdWidgetSelectAndAddMultipleChoices(array('choices'=>$values,'expanded' => false,'multiple' => true));
	}
