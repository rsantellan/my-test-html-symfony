...
class mdAttributeWidgetTextNumeric extends mdAttribute implements iMdAttribute{
	...
	public function getWidget(){
		...
		return new sfWidgetFormInputConfigurable(array('value'=>0));
	}
	...
	public function getValidator(){
		...
		return new sfValidatorNumber(array('required'=>$requiered));
